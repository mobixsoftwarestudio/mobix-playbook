...
1. Figma Links: In this part, links are added to the story flow and to the navigable prototype of the screens.
2. Acceptance Criteria: Informs the development and QA team how to get to the feature by browsing the software (input), what the feature does (behavior) and how to get out of it (output).
3. Use cases: It is in this topic that the business rules of the feature will be explained.
